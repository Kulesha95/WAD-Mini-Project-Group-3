    ...
    <div class="card">
        <div class="card-header bg-white">
            <div class="row">
                ...
                <h4 class="ml-2 my-auto">About Us Page</h4>
            </div>
        </div>
        <div class="card-body">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="setting" role="tabpanel" aria-labelledby="setting-tab">
                    <form action="addController.php" method="POST" class="m-3" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="description" class="col-12 col-md-2 col-xl-1">About</label>
                            <textarea class="form-control form-control-sm col-12 col-md-10 col-xl-11" id="description"
                                name="description"
                                placeholder="Description"><?php echo cmsGetSingle("description", "about");?></textarea>
                        </div>
                        <div class="form-group row">
                            <label for="vision" class="col-12 col-md-2 col-xl-1">Vision</label>
                            <input type="text" class="form-control form-control-sm col-12 col-md-10 col-xl-11"
                                id="vision" name="vision" placeholder="Vision"
                                value="<?php echo cmsGetSingle("vision", "about"); ?>">
                        </div>
                        <div class="form-group row">
                            <label for="mission" class="col-12 col-md-2 col-xl-1">Mission</label>
                            <input type="text" class="form-control form-control-sm col-12 col-md-10 col-xl-11"
                                id="mission" name="mission" placeholder="Mission"
                    ...
                    <form action="addController.php" method="POST" class="m-4" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="icon" class="col-12 col-md-2 col-xl-1">Icon</label>
                        ...
                        <div class="form-group row">
                            <label for="line1" class="col-12 col-md-2 col-xl-1">Line 1</label>
                            <input type="text" class="form-control form-control-sm col-12 col-md-10 col-xl-11"
                                id="line1" name="line1" placeholder="Line 1">
                        </div>
                        <div class="form-group row">
                            <label for="line2" class="col-12 col-md-2 col-xl-1">Line 2</label>
                            <input type="text" class="form-control form-control-sm col-12 col-md-10 col-xl-11"
                                id="line2" name="line2" placeholder="Line 2">
                        </div>
                        <div class="form-group row d-flex">
                            <button name="Save" value="Save" type="submit" class="btn btn-primary btn-sm ml-auto"><i
                                    class="fas fa-save mr-2"></i>Save</button>
                        ...
                        <div class="col-12 col-md-4 mx-auto mt-4">
                            <div class="card">
                                <div class="card-header d-flex">
                                    <a href="deleteController.php?id=<?php echo cmsGetMultipleId("icon","about",$groupCode)?>"
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <span class="fa-stack fa-4x text-dark mx-auto">
                                            ...
                                            <i
                                                class="<?php echo cmsGetMultiple("icon","about",$groupCode);?> fa-stack-1x text-light"></i>
                                        </span>
                                    </div>
                                    <div class="row">
                                        <h2 class="mx-auto"><?php echo cmsGetMultiple("line1","about",$groupCode);?>
                                        </h2>
                                    </div>
                                    <div class="row">
                                        <h3 class="mx-auto"><?php echo cmsGetMultiple("line2","about",$groupCode);?>
                                        </h3>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="tab-pane fade" id="image" role="tabpanel" aria-labelledby="image-tab">
                    <form action="addImageController.php" method="POST" class="m-3" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="number" class="col-12 col-md-2 col-xl-1">Start</label>
                            <div class="custom-file col-12 col-md-10 col-xl-11">
                    ...
                    <form action="addImageController.php" method="POST" class="m-3" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="number" class="col-12 col-md-2 col-xl-1">Middle</label>
                            <div class="custom-file col-12 col-md-10 col-xl-11" required>
