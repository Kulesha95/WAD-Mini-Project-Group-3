    ...
    <div class="card">
        <div class="card-header bg-white">
            <div class="row">
                ...
                <h4 class="ml-2 my-auto">Contact Page Settings</h4>
            </div>
        </div>
        <div class="card-body">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="setting" role="tabpanel" aria-labelledby="setting-tab">
                    <form action="addController.php" method="POST" class="m-3" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="number" class="col-4 col-md-2">Number</label>
                            <input type="text" class="form-control form-control-sm col-8 col-md-10" id="contactNumber"
                                name="contactNumber" placeholder="Contact Number"
                                value="<?php echo cmsGetSingle("contactNumber", "contact"); ?>">
                        </div>
                        <div class="form-group row">
                            <label for="addressLine1" class="col-4 col-md-2">Address Line 1</label>
                            <input type="text" class="form-control form-control-sm col-8 col-md-10" id="addressLine1"
                                name="addressLine1" placeholder="Address Line 1"
                                value="<?php echo cmsGetSingle("addressLine1", "contact"); ?>">
                        </div>
                        <div class="form-group row">
                            <label for="addressLine2" class="col-4 col-md-2">Address Line 2</label>
                            <input type="text" class="form-control form-control-sm col-8 col-md-10" id="addressLine2"
                                name="addressLine2" placeholder="Address Line 2"
                                value="<?php echo cmsGetSingle("addressLine2", "contact"); ?>">
                        </div>
                        <div class="form-group row">
                            <label for="website" class="col-4 col-md-2">Website</label>
                            <input type="text" class="form-control form-control-sm col-8 col-md-10" id="website"
                                name="website" placeholder="Website"
                                value="<?php echo cmsGetSingle("website", "contact"); ?>">
                        </div>
                        <div class="form-group row">
                            <label for="email" class="col-4 col-md-2">E-Mail</label>
                            <input type="text" class="form-control form-control-sm col-8 col-md-10" id="email"
                                name="email" placeholder="E-Mail"
                                value="<?php echo cmsGetSingle("email", "contact"); ?>">
                        </div>
                        <div class="form-group row">
                            <label for="googleMapSrc" class="col-4 col-md-2">Google Map</label>
                            <input type="text" class="form-control form-control-sm col-8 col-md-10" id="googleMapSrc"
                ...
                <div class="tab-pane fade" id="image" role="tabpanel" aria-labelledby="image-tab">
                    <form action="addImageController.php" method="POST" class="m-3" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="number" class="col-4 col-md-2">Write Us Image</label>
