        ...
        <div class="card-body">
            <form action="roomImageController.php" method="POST" class="m-3" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <label for="name" class="col-12 col-md-4 col-xl-2">Room Image</label>
                    <div class="custom-file mb-3 col-12 col-md-8 col-xl-10">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4 p-3">
                    <div class="row">
                        <img src="../../<?php echo $roomData['path']?>" class"img-fluid"
                            style="height:30vh; width:100%;object-fit:cover">
                    </div>
                    <div class="row">
                        <a class="btn btn-danger btn-sm mx-auto"
                            href="roomImageDeleteController.php?id=<?php echo $roomData['id'];?>&roomId=<?php echo $_GET['id']?>"
