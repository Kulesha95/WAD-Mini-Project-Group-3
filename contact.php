...
<div class="container bg-white">
    <section class="contact-details section-gap">
        <div class="row justify-content-center">
            <span class="justify-content-between text-secondary mr-3 d-none d-md-block">__________________</span>
            <h2 class="heading">contact us</h2>
            <span class="justify-content-between text-secondary ml-3 d-none d-md-block">__________________</span>
        </div>
        <div class="row mt-5">
            <div class="col-12 col-md-6 mb-3">
                <div class="row contact-detail-item">
                    <div class="col-2"><i class="fas fa-phone-alt fa-2x"></i></div>
                    <div class="col-10"><a class="no-deco text-dark" href="tel:+94312228000">+94312228000</a></div>
                </div>
                <div class="row contact-detail-item">
                    <div class="col-2"><i class="fas fa-map-marker-alt fa-2x"></i></div>
                    <div class="col-10">
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-6">
                <form action="">
                    ...
                    <div class="row m-3">
                        <button type="submit" class="btn btn-danger form-control form-control-lg"><i
        ...
        <section class="reviews section-gap">
            ...
            <div class="row mt-5">
                ...
                <div class="col-md-4 review-card-container" id="review-card-container">
                    <div class="card bg-white shadow review-card-before">
